...
public partial class Share_medical_sliderHome : System.Web.UI.UserControl
{
    ...
    public void getSlider()
    {
        ...
        foreach (DataRow row in dtSlider.Rows)
        {
            ...
            {
                html += "<a href='" + BaseView.GetStringFieldValue(row, "url") + "' ><img src='/UploadFile/slider/" + BaseView.GetStringFieldValue(row, "filename") + "' data-thumb='/UploadFile/slider/" + BaseView.GetStringFieldValue(row, "filename") + "' alt='" + BaseView.GetStringFieldValue(row, "name") + "' title='#caption2' /></a>";
            }
            else
                html += "<a href='../" + BaseView.GetStringFieldValue(row, "url") + "'><img src='/UploadFile/slider/" + BaseView.GetStringFieldValue(row, "filename") + "' data-thumb='/UploadFile/slider/" + BaseView.GetStringFieldValue(row, "filename") + "' alt='" + BaseView.GetStringFieldValue(row, "name") + "' title='#caption2' /></a>";
