                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                    ...
                                    <br />
                                    <asp:Image ID="imgBS" runat="server" Width="100%" />
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                    ...
                                    <asp:CheckBox ID="chkSudung" runat="server" CssClass="flat-red" />
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                    ...
                                    <asp:Button ID="btnThem" runat="server" Text="Clear" OnClick="btnThem_Click" CssClass="btn-blue"/>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <br />
                        <asp:Button ID="btnXoa" runat="server" Text="Xóa mục đã chọn" OnClick="btnXoa_Click"  CssClass="btn-orange"/>
                        <asp:Button ID="btnActived" runat="server" OnClick="btnActived_Click" Text="Mở hình đã chọn"  CssClass="btn-blue"/>
                        <asp:Button ID="btnDeactived" runat="server" OnClick="btnDeactived_Click" Text="Tắt hình đã chọn"  CssClass="btn-orange"/>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <asp:GridView ID="grvData" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:Image ID="Image1" Height="40px" runat="server" ToolTip='<%# Eval("filename") %>' />
                                    </ItemTemplate>
                                ...
                                <asp:CheckBoxField DataField="IsActived" HeaderText="Sử dụng" />
