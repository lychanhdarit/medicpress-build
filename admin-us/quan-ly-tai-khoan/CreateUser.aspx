<%@ Page Title="" Language="C#" MasterPageFile="~/admin-us/share/admin-master.master" AutoEventWireup="true" CodeFile="CreateUser.aspx.cs" Inherits="admin_us_quan_ly_tai_khoan_CreateUser" %>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddlUser" runat="server" CssClass="ddlStyle form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlUser_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnThem" runat="server" Text="Thêm" OnClick="btnThem_Click" CssClass="btn-orange"/>
                            <asp:Button ID="btnCapNhat" runat="server" Text="Sửa" OnClick="btnCapNhat_Click" Visible="false" />
