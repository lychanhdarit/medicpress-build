...
public partial class admin_us_quan_ly_tai_khoan_CreateUser : System.Web.UI.Page
{
    ...
    private void getItem(string username)
    {
    ...
    protected void btnCapNhat_Click(object sender, EventArgs e)
    {
        ...
        if (r != null)
        {
            ...
            _db.insert_update_delete_cms_user(txtUserName.Text.Trim(), BaseView.md5(txtUserName.Text.Trim() + "123"), txtHoTen.Text, txtEmail.Text, txtDienThoai.Text, chkActived.Checked, getQuyen(), UrlImages, UserLogin, UserLogin, Ip, "update");
