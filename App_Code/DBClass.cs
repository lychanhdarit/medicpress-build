...
public class DBClass : BaseServ
{
    ...
    public DataTable Get_Top_News_DanhMuc_SEO(string urlLoai, int top, int isSEO)
    {
        return GetDataTable("Get_Top_News_CodeLoai_SEO", urlLoai, top, isSEO);
    }
    public DataTable Get_All_News_Loai_SEO(int maLoai, int isSEO)
    {
        return GetDataTable("[Get_All_News_Loai_SEO]", maLoai, isSEO);
    }
    public DataTable Get_Top_SEO_Loai(int maLoai,int Top, int isSEO)
    {
        return GetDataTable("[Get_Top_SEO_Loai]", maLoai,Top, isSEO);
    }
